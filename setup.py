...
setup(
    name='NetworkPerformanceMonitor',
    version='0.1',
    packages=['venv.lib.python3.6.site-packages.iperf3', 'venv.lib.python3.6.site-packages.multiping',
    ...
    license='',
    author='Davide Volta',
    author_email='davidevolta98@gmail.com',
    description=''
)
